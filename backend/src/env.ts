...
export const env = {
  ...
  // ERP 전용 팀 배포. 프로덕션 기본값 = 승인된 멤버만 접근 + 초대받은 이메일만 가입.
  ...
  googleSheets: {
    ...
    marketingDashboardSpreadsheetId:
      process.env.GOOGLE_SHEETS_MARKETING_DASHBOARD_SPREADSHEET_ID ??
      "1UQyMDvSjXlQy1jzmP0_Rd4Fitcn4TJlsxlTJPvm72wI",
