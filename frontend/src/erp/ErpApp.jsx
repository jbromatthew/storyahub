...
export default function ErpApp() {
  ...
  if (kbView) {
    ...
    switch (tab) {
      ...
      case "sales-stats": return <SalesStatsView />;
      case "churn": return <ChurnView />;
