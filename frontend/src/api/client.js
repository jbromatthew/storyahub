...
export const api = {
  ...
  erpRndSegmentDelete: (id) => req(`/erp/rnd/segments/${id}`, { method: "DELETE" }),
  ...
  erpConstructionAdvances: (orderType) =>
    req(`/erp/construction/advances${orderType ? `?orderType=${encodeURIComponent(orderType)}` : ""}`),
  erpConstructionCreateAdvance: (data) => req("/erp/construction/advances", { method: "POST", body: data }),
  erpConstructionUpdateAdvance: (id, data) => req(`/erp/construction/advances/${id}`, { method: "PATCH", body: data }),
  erpConstructionDeleteAdvance: (id) => req(`/erp/construction/advances/${id}`, { method: "DELETE" }),
  erpConstructionSettlements: (orderType) =>
    req(`/erp/construction/settlements${orderType ? `?orderType=${encodeURIComponent(orderType)}` : ""}`),
  erpConstructionCreateSettlement: (data) => req("/erp/construction/settlements", { method: "POST", body: data }),
  erpConstructionDeleteSettlement: (id) => req(`/erp/construction/settlements/${id}`, { method: "DELETE" }),
